...
import getTokenInfoQuery, { GET_TOKEN_INFO_QUERY_TOOL } from './tools/queries/get-token-info-query';
import getPendingAirdropQuery, {
  GET_PENDING_AIRDROP_TOOL,
} from './tools/queries/get-pending-airdrop-query';
