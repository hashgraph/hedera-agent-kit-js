...
function derive(
  input: Parameters<typeof deriveActivity>[0],
...
function assistantMessage(parts: ChatMessagePart[]): ChatMessage {
  return { id: "asst-1", role: "assistant", parts };
}

function textPart(text: string, state: "streaming" | "done"): ChatTextPart {
...
type ActivityTransition = {
  label: string;
  view: ReturnType<typeof deriveActivity>;
};
