...
export type ChatMessageProps = {
  ...
  // When the message is the live assistant turn, the orchestrator supplies the
  // activity input; otherwise `null` and the activity slot collapses.
...
// is stable on V8.
function orderToolsFirst(parts: ChatMessagePart[]): ChatMessagePart[] {
