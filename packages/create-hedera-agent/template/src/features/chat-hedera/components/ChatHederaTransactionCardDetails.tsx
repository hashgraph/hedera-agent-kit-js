...
import type { ChatHederaTransactionCardState } from "@/features/chat-hedera/utils/transaction-card-state";

export type ChatHederaTransactionCardDetailsProps = {
  summary: Summary;
...
export function ChatHederaTransactionCardDetails({
  ...
  transactionId,
  errorMessage,
}: ChatHederaTransactionCardDetailsProps) {
