...
export class UsdToHbarService {
  ...
  /**
   * Set the exchange rate directly from a cached value (e.g. process.env).
   * Avoids redundant network calls in per-worker setup files.
   */
  static setExchangeRate(rate: number): void {
