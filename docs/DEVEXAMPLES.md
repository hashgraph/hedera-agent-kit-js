...
```bash
node packages/mcp/dist/bin/stdio.js
```
...
1. First, set up the Hedera MCP server by following the instructions in the [modelcontextprotocol README](../examples/modelcontextprotocol/README.md):
