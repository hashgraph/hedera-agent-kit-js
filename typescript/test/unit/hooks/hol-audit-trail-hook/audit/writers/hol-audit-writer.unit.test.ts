...
import { HolAuditWriter } from '@/shared/hooks/hol-audit-trail-hook/audit/writers/hol-audit-writer';
...
vi.mock('@/shared/hooks/hol-audit-trail-hook/hol/hcs2-registry-builder', () => ({
  Hcs2RegistryBuilder: {
...
vi.mock('@/shared/hooks/hol-audit-trail-hook/hol/hcs1-file-builder', () => ({
  Hcs1FileBuilder: {
