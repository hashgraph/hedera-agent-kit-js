...
describe.skip('Schedule Delete Tool Matching Integration Tests', () => {
  ...
  describe.skip('Tool Matching and Parameter Extraction', () => {
    it.skip('should match schedule delete tool for simple delete request', async () => {
    ...
    it.skip('should match schedule delete tool with different wording', async () => {
    ...
    it.skip('should match schedule delete tool with "abort" wording', async () => {
    ...
    it.skip('should extract correct parameters for complex delete request', async () => {
  ...
  describe.skip('Tool Available', () => {
    it.skip('should have schedule delete tool available', () => {
