...
async function bootstrap(): Promise<void> {
    ...
    const agent = new LlmAgent({
        name: 'hedera_agent',
        description: 'An AI agent that can interact with the Hedera blockchain network using various tools for account management, token operations, consensus service, and more.',
        model: 'gemini-3.1-flash-lite-preview',
        instruction: 'You are a helpful assistant with access to Hedera blockchain tools. You can help users create accounts, transfer HBAR, manage tokens, create topics, and query blockchain information. Always provide clear explanations of the transactions you perform.',
    ...
    console.log("  - Create a new topic called 'Daily Updates'");
    ...
    while (true) {
        ...
        try {
            // Create user message content (matching Python's types.Content)
            ...
            // Process events and print final response
